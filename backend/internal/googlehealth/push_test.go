...
func TestPushService_PushWeight(t *testing.T) {
	...
	err := service.PushWeight(context.Background(), userID, "dp-1", 70, recordedAt)
...
func TestPushService_PushWeight_NotConnected(t *testing.T) {
	...
	err := service.PushWeight(context.Background(), uuid.New(), "dp-1", 70, time.Now())
